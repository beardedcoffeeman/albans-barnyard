            ...
            >
              ...
              <form className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block font-sans text-xs tracking-wider uppercase text-stone-500 mb-2">
                      Name
                    </label>
                    <input
                      type="text"
                      className="w-full px-4 py-3 border border-stone-200 font-sans text-sm text-stone-900 focus:outline-none focus:border-green-mid transition-colors bg-transparent"
                ...
                <div>
                  ...
                  <textarea
                    rows={6}
                    className="w-full px-4 py-3 border border-stone-200 font-sans text-sm text-stone-900 focus:outline-none focus:border-green-mid transition-colors bg-transparent resize-none"
                    placeholder="Tell us how we can help..."
                  />
                </div>
                <button
                  type="submit"
                  className="px-10 py-4 bg-green-dark text-white font-sans text-sm tracking-[0.2em] uppercase hover:bg-green-mid transition-colors duration-300"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="font-sans text-stone-600">
                    ...
                    <br />
                    <a
                      href="mailto:mail@albansbarnyard.co.uk"
                      className="hover:text-green-dark transition-colors"
                    >
                      mail@albansbarnyard.co.uk
                    </a>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      className="flex items-center gap-2 font-sans text-sm text-stone-600 hover:text-[#1877F2] transition-colors"
                    >
                    ...
                    <a
                      href="https://www.instagram.com/albansbarnyard"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 font-sans text-sm text-stone-600 hover:text-[#E4405F] transition-colors"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
