  ...
  sections: [
    ...
    },
    {
      ...
      fields: {
        ...
        paragraph1: "Alban's Barnyard is a small family farm nestled in the Kentish Weald, where we raise pedigree Jacob sheep and North Devon Red Ruby cattle using traditional, high-welfare methods.",
