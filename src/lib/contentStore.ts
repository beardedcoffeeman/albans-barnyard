...
const defaultContent: SiteContent = {
  sections: [
    ...
    {
      id: "cottage-amenities",
      page: "cox-cottage",
      label: "Cottage Amenities",
      fields: {
        kitchenTitle: "Kitchen",
        kitchenItems: "Hand-built wooden kitchen|Granite worktops|Integrated Neff appliances|Full-size fridge freezer|Nespresso coffee machine|Dishwasher",
        livingTitle: "Living",
        livingItems: "Dijon limestone flooring|Charnwood wood burning stove|Underfloor heating throughout|Sonos audio system|Freesat TV & DVD collection|Wi-Fi & wired internet",
        bedroomsTitle: "Bedrooms",
        bedroomsItems: "Ground floor king bed (converts to twin)|Ensuite shower room|Upper floor double bed|Juliet balcony|Ensuite with shower-over-bath|Premium bed linen & towels",
        outdoorTitle: "Outdoor",
        outdoorItems: "Private rear garden|Patio with outdoor seating|Parking for two cars|Farm walks on the doorstep|BBQ available on request",
      },
    },
    {
      id: "cottage-sustainability",
      page: "cox-cottage",
      label: "Sustainability Features",
      fields: {
        feature1Title: "Solar Powered",
        feature1Text: "Roof-mounted solar panels generate renewable energy",
        feature2Title: "Ground Source Heat",
        feature2Text: "Geothermal heat pump for efficient underfloor heating",
        feature3Title: "Heat Recovery",
        feature3Text: "Mechanical ventilation with heat recovery system",
      },
    },
    {
      id: "farm-intro",
    ...
    },
    {
      ...
      label: "Navigation",
      fields: {
        logoText: "Albans Barnyard",
        homeLabel: "Home",
        cottageLabel: "Cox Cottage",
        lambcamLabel: "Lambcam",
        farmLabel: "The Farm",
        shopLabel: "Farm Shop",
        contactLabel: "Contact",
        bookNowText: "Book Now",
        bookNowLink: "/cox-cottage#booking",
      },
    },
    {
      id: "footer",
      ...
      label: "Footer",
      fields: {
        description: "A Weald of Kent cottage on a working farm, just five miles from Tunbridge Wells. One of the finest places to stay in Kent.",
        address: "Romford Road, Pembury\nKent, TN2 4BB",
        phone: "+44 (0)1892 826052",
        email: "mail@albansbarnyard.co.uk",
        stayColumnTitle: "Stay",
        cottageLabel: "Cox Cottage",
        ...
        copyright: "\u00a9 2026 Albans Barnyard. All rights reserved.",
      },
    },
    {
      id: "guest-book",
      ...
      label: "Guest Book",
      fields: {
        pdfUrl: "https://www.albansbarnyard.co.uk/wp-content/uploads/2025/05/coxcottageguestbook9.pdf",
        eyebrow: "Guest Book",
        title: "What Our Guests Say",
        subtitle: "Real entries from our handwritten guest book at Cox Cottage, complete with drawings, doodles, and heartfelt messages.",
        cardTitle: "The Guest Book",
        cardSubtitle: "9 volumes of handwritten memories",
        cardEyebrow: "Authentic Reviews",
        cardHeading: "Handwritten by Our Guests",
        cardDescription: "Every guest leaves their mark in our handwritten guest book, complete with personal stories, drawings, children's doodles, and heartfelt thank-yous. No online reviews can capture the warmth of these pages.",
        browseText: "Browse the Guest Book",
        closeText: "Close Guest Book",
      },
    },
  ],
};
